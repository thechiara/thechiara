...
struct powerpc_operand
{
  ...
  unsigned long long (*insert)
    (unsigned long long instruction, signed long long op, ppc_cpu_t dialect, const char **errmsg);
  ...
  signed long long (*extract) (unsigned long long instruction, ppc_cpu_t dialect, int *invalid);
